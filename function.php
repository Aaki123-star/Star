...
function print_attock_bottom_frontpage() {
    if ( is_front_page() ) {
        echo '<div style="text-align:center; padding:20px; font-size:28px; font-weight:bold;">
                ATTOCK
              </div>';
    }
}
add_action( 'generate_after_main_content', 'print_attock_bottom_frontpage' );
